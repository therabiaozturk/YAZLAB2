...
# --- SABİT VERİLER (Senaryo/Test Amaçlı) ---
...
# --- SABİT NESNE OLUŞTURUCU FONKSİYONLAR ---

def sabit_dron_nesneleri():
    return [Drone(**d) for d in sabit_dronlar]

def sabit_teslimat_nesneleri():
    return [Teslimat(**t) for t in sabit_teslimatlar]

def sabit_noflyzone_nesneleri():
    return [NoFlyZone(**n) for n in sabit_no_fly_zones]
